...
local DEFAULT = function(self)
    if not ACHV[self.id] then return true
...
Achievements = {
    ...
    { -- swamp_water_lite
        ...
        desc = [[HFD WU 7/8 of the difficulty mods ("Duo" not allowed), excluding the "PENTR.IO" mod]],
    ...
    { -- swamp_water
        id = 'swamp_water',
        name = "Swamp Water",
        desc = [[HFD WU all mods other than "Duo" at the same time, excluding the "PENTR.IO" mod]],
    ...
    { -- swamp_water_pro
        ...
        desc = [[HFD WU all mods at the same time, excluding the "PENTR.IO" mod]],
    ...
    { -- swamp_water_lite_plus
        ...
        name = "Ambrosia Soda",
        desc = [[HFD WU 1 reverse mod + 6 mods ("Duo" not allowed), excluding the "PENTR.IO" mod]],
        quote = [[A watered down solution, which comes in 56 peculiar flavors.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2000),
        hide = function() return TABLE.countAll(GAME.completion, 0) == 10 end,
    },
    { -- swamp_water_plus
        ex = true,
        id = 'swamp_water_plus',
        name = "Ambrosia Wine",
        desc = [[HFD WU 1 reverse mod + 7 mods ("Duo" not allowed), excluding the "PENTR.IO" mod]],
    ...
    { -- swamp_water_pro_plus
        ...
        desc = [[HFD WU 1 reverse mod + 8 mods, excluding the "PENTR.IO" mod]],
        quote = [[Highly inebriating whiskey with a strong, yet beautiful taste.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 1800),
        hide = function() return TABLE.countAll(GAME.completion, 0) == 10 end,
    },

    { title = "Why",           hide = function() return TABLE.countAll(GAME.completion, 0) >= 10 end, credit = "@MrZ @Flowerling" },
    { -- blight
        ex = true,
        id = 'blight',
        name = "Blight",
        ...
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
        hide = function() return TABLE.countAll(GAME.completion, 0) > 8 end,
    },
    { -- desolation
        ex = true,
        id = 'desolation',
    ...
    { -- abyss
        ...
        quote = [[...and soon, there won't be anything left for us anymore...]],
    ...
    { -- mastery
        ...
        id = 'mastery',
        name = "Mastery",
        desc = [[Mastery on all single mods, excluding the "PENTR.IO" mod]],
    ...
    { -- terminal_velocity
        ...
        desc = [[Speedrun all single mods, excluding the "PENTR.IO" mod]],
    ...
    { -- the_harbinger
        id = 'the_harbinger',
        name = "The Harbinger",
        desc = [[Reach floor 5 in all nine base game reversed mods]],
    ...
    { -- false_god
        ...
        id = 'false_god',
        name = "False God",
        desc = [[Mastery on all mods, excluding the "PENTR.IO" mod]],
    ...
    { -- subjugation
        ...
        id = 'subjugation',
        name = "Subjugation",
        desc = [[Mastery on all single rev mods, excluding the "PENTR.IO" mod]],
    ...
    { -- omnipotence
        ...
        id = 'omnipotence',
        name = "Omnipotence",
        desc = [[Speedrun all single rev mods, excluding the "PENTR.IO" mod]],
    ...
    { title = "A Fool's Mod", credit = "@FCSplayz" },
    { -- PN
        id = 'PN',
        name = "The Fool",
        desc = [[HFD with the "PENTR.IO" mod]],
        quote = [[A journey of one thousand six hundred fifty meters starts with a single step.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
    },
    { -- rPN
        id = 'rPN',
        name = "A Fool's Errand",
        desc = [[HFD with the reversed "PENTR.IO" mod]],
        quote = [[You'll never escape who you are.]],
        hide = function() return GAME.completion.PN == 0 end,
        rank = floorRank(1, 3, 5, 7, 9, 10, 2200),
    },
    { -- why_lite
        id = 'why_lite',
        name = "Why Lite",
        desc = [[HFD WU 8/9 of the difficulty mods ("Duo" not allowed)]],
        quote = [[Comes in 8 different flavors that are totally original!]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
    },
    { -- why
        id = 'why',
        ...
        quote = [[How could it get any worse?!]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 2000),
    },
    { -- why_pro
        ex = true,
    ...
    { -- why_pro_plus
        ...
        id = 'why_pro_plus',
        name = "Ambrosia Ichor",
        desc = [[HFD WU 1 reverse mod + 9 mods]],
        quote = [[An ethereal, mythic and virulent solution, distilled from the blood of immortals.]],
        rank = floorRank(1, 3, 5, 7, 9, 10, 1800),
        hide = function() return TABLE.countAll(GAME.completion, 0) > 1 end,
    },
    { -- FM_spaghettification
        ex = true,
        id = 'FM_spaghettification',
        name = "Spaghettification",
        desc = [[HAR with 19+ mod points]],
        quote = [[...naught to do but watch the world tear itself to shreds...]], -- @Flowerling
        rank = numberRank(0, 20, 30, 40, 50, 62.6, 80),
    ...
    { -- FM_singularity
        ...
        id = 'FM_singularity',
        name = "Singularity",
        desc = [[HAR with 20 mod points]],
        quote = [[...as it all collapses into nothingness.]], -- @Flowerling
        rank = numberRank(0, 16.2, 20, 26, 35, 50, 62.6),
        hide = function() return TABLE.countAll(GAME.completion, 0) > 0 end,
    },
    { -- FM_jokes_on_you
        id = 'FM_jokes_on_you',
        name = "Joke's On You!",
        desc = [[HAR with PN on the 1st day of any month (No CR)]],
    ...
    { -- FM_fools_gold
        id = 'FM_fools_gold',
        name = "Fool's Gold",
        desc = [[HAR with rPN on the 1st day of any month (No CR)]],
        quote = [[...fool me twice, shame on me.]],
        scoreSimp = heightNumber,
        rank = floorRank(1, 3, 5, 7, 9, 10, 2600),
        hide = function() return not ACHV.FM_jokes_on_you end,
        type = 'event',
    },

    { title = "A Fool's Mod - Ultras", credit = "@FCSplayz", lazy = true },
    { -- FM_mvp_list
        id = 'FM_mvp_list',
        name = "MVP List",
        desc = [[Number of ultra daily combos mastered]],
        quote = [["Amongst extraordinary elites, the Clicker Hall awaits thee..."]],
        scoreSimp = function(day) return day == 1 and "1 Day" or day .. " Days" end,
        rank = numberRank(0, 0, 0, 1, 2, 3, 5),
        realHide = DEFAULT,
    },

    { title = "A Fool's Mod - Issued A (No CR)", credit = "@FCSplayz" },
    { -- FM_ascension
        ex = true,
        id = 'FM_ascension',
        name = "Ascension",
        desc = [[Mastery on all single mods]],
        quote = [[Mastery of one is but the beginning. The rest awaits the truly ascended.]],
        hide = function() return not ACHV.mastery end,
        type = 'issued'
    },
    { -- FM_speedy_student
        ex = true,
        id = 'FM_speedy_student',
        name = "Speedy Student",
        desc = [[Speedrun all single mods]],
        quote = [["No running in the halls!"]],
        credit = "@The_111thBlitzer",
        hide = function() return not ACHV.terminal_velocity end,
        type = 'issued',
    },
    { -- FM_transcension
        ex = true,
        ...
        quote = [["Master of all, deserving of peace. Rest well, transcended one."]],
        type = 'issued',
        hide = TRUE,
    },
    { -- FM_a_fools_divination
        ex = true,
        id = 'FM_a_fools_divination',
        name = "A Fool's Divination",
        desc = [[Speedrun all single rev mods]],
        quote = [[Thy will bends even the outskirts of any and every universe...]],
        credit = "@FMichael",
        type = 'issued',
        hide = TRUE,
    },
    { -- FM_the_foretold
        id = 'FM_the_foretold',
        name = "The Foretold",
        desc = [[Reach floor 5 in all ten reversed mods]],
        quote = [["The signs were clear, the end was grueling. You endured it anyway."]],
        hide = TRUE,
        type = 'issued',
    },
    { -- FM_true_god
        ...
        quote = [["What began in foolishness ends in divinity. Even gods must start somewhere."]],
        hide = TRUE,
        type = 'issued'
    },
    
    { title = "A Fool's Mod - Issued B (No CR)", credit = "@FCSplayz" },
    { -- FM_foolish_horizons
        id = 'FM_foolish_horizons',
        name = "Foolish Horizons",
        desc = [[Import your base Zenith Clicker save to Zenith Clicker (A Fool's Mod)]],
        quote = [["So... the fool seeks more, I see? May your reach know no bounds, clicker."]],
        type = 'issued'
    },

    { title = "Experimental Achievements", credit = "@FCSplayz", lazy = true },
    {
        id = 'FM_experimental_achv_test',
        name = "Experimental Achievement Test",
        desc = [[This is a test for the Experimental Achievements category]],
        quote = [[as well as for the achievement itself.]],
        type = 'issued',
        realHide = TRUE,
        experimental = true
    },
