...
function scene.update(dt)
    ...
    elseif t1 > 0 then
        ...
        if t1 <= 0 then
            ...
            SFX.load('card_tone_pento', 'assets/card_tone_pento.ogg')
            SFX.load('card_tone_pento_reverse', 'assets/card_tone_pento_reverse.ogg')
            SFX.load('card_reverse_impact_janktacular', 'assets/card_reverse_impact_janktacular.ogg')
            SFX.load('card_tone_snowman', 'assets/card_tone_snowman.ogg')
            SFX.load('card_tone_snowman_reverse', 'assets/card_tone_snowman_reverse.ogg')
            SFX.load('garbagewindup_5', 'assets/windup_5.ogg')
            SFX.load('garbagewindup_6', 'assets/windup_6.ogg')
            for w = 1, 6 do SFX.load('garbagewindup_' .. w .. '_reverse', 'assets/windup_' .. w .. '_reverse.ogg') end
            GAME.updateBgm('init')
